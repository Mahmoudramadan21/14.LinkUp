...
const FullStoryViewerPage = memo(() => {
  ...
  if (process.env.NODE_ENV === 'development') {
    console.log('Rendering FullStoryViewerPage:', {
      username,
      currentStoryFeedItem,
      currentIndex,
  ...
  // Wait for currentIndex to be set before rendering modal
  if (currentIndex === null) {
    return <Loading />;
  }

  return (
    <div ref={containerRef} tabIndex={-1} role="region" aria-label="Story viewer page">
