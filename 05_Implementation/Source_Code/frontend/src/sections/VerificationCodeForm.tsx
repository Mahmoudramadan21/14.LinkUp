...
const VerificationCodeForm: React.FC = () => {
  ...
  // Retrieve and validate email from localStorage
  useEffect(() => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      // Store the resetToken in localStorage
  ...
  // If there's an email error, show a message with a link to /forgot-password
  if (errors.email) {
    return (
